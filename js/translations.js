/* ================================================
   AI with Robert — translations.js
   Update this file to change any visible text on
   the site in English or French.
   ================================================ */

const translations = {
    en: {
        'nav-home':'Home','nav-services':'Services','nav-pricing':'Pricing','nav-faq':'FAQ','nav-about':'About Robert','nav-contact':'Contact',
        ...
        'stat-local':'Local','stat-local-label':'Côte Saint-Luc',
        'stat-expert':'Expert','stat-expert-label':'Years Experience',
        'stat-patient':'Patient','stat-patient-label':'One-on-One Teaching',
        'stat-free':'Free','stat-free-label':'Discovery Call',
        ...
        'pricing-single':'Single Session','pricing-single-details':'per hour',
        'pricing-single-online':'Online','pricing-single-home':'In-home',
        'pricing-single-note':'Perfect for trying out lessons',
        'pricing-starter':'Starter Package','pricing-starter-details':'5 hours \u2022 Save $25',
        'pricing-starter-rate':'Just $55/hour',
        'pricing-starter-note':'Great for building confidence over multiple sessions',
        'pricing-complete':'Complete Package','pricing-complete-details':'10 hours \u2022 Save $100',
        'pricing-complete-rate':'Only $50/hour',
        'pricing-complete-note':'Comprehensive learning for mastering new skills',
        'pricing-group':'Group Workshop','pricing-group-details':'per person',
        'pricing-group-duration':'90 minutes','pricing-group-size':'2-4 people (max 6)',
        'pricing-group-note':'Learn together, save money',
        'badge-best':'Best Value','badge-popular':'Most Popular',
        ...
        'exp-teaching':'Years of Teaching','exp-passion':'Passionate About Seniors',
        'exp-local':'Local Resident','exp-ai':'AI Specialist',
        ...
        'form-name':'Your Name','form-email':'Email Address','form-phone':'Phone Number',
        'form-interest':"I'm Interested In",
        'form-referral':'How Did You Hear About Me?','form-optional':'Optional',
        'form-referral-choose':'Choose an option...','form-referral-google':'Google Search',
        'form-referral-ai':'ChatGPT / AI Search','form-referral-friend':'Friend or Family',
        'form-referral-neighbour':'Neighbour','form-referral-csl':'CSL Community Board / Bulletin',
        'form-referral-facebook':'Facebook','form-referral-linkedin':'LinkedIn',
        ...
        'form-option-choose':'Choose an option...','form-option-online':'One-on-One (Online)',
        'form-option-home':'One-on-One (In-Home)','form-option-group':'Group Workshop',
        ...
        'entity-aside':'<strong>AI with Robert</strong> — AI tutoring &amp; technology training for seniors in Côte Saint-Luc, QC. Robert Simon teaches ChatGPT, internet safety, email security, smartphones &amp; video calling. In-home $65/hr &middot; Online $60/hr &middot; AI workshops $35/person &middot; Free 30-min discovery call. &#128222; <a href="tel:514-250-8491">514-250-8491</a> &nbsp;&middot;&nbsp; <a href="mailto:info@aiwithrobert.com">info@aiwithrobert.com</a>'
    },
    fr: {
        'nav-home':'Accueil','nav-services':'Services','nav-pricing':'Tarifs','nav-faq':'FAQ','nav-about':'\u00c0 Propos','nav-contact':'Contact',
        ...
        'stat-local':'Local','stat-local-label':'C\u00f4te Saint-Luc',
        'stat-expert':'Expert','stat-expert-label':"Ann\u00e9es d'Exp\u00e9rience",
        'stat-patient':'Patient','stat-patient-label':'Cours Particuliers',
        'stat-free':'Gratuit','stat-free-label':'Appel D\u00e9couverte',
        ...
        'pricing-single':'S\u00e9ance Individuelle','pricing-single-details':'par heure',
        'pricing-single-online':'En ligne','pricing-single-home':'\u00c0 domicile',
        'pricing-single-note':"Id\u00e9al pour s'initier aux le\u00e7ons",
        'pricing-starter':'Forfait D\u00e9butant','pricing-starter-details':'5 heures \u2022 \u00c9conomisez 25$',
        'pricing-starter-rate':'Seulement 55$/heure',
        'pricing-starter-note':'Parfait pour b\u00e2tir votre confiance au fil des s\u00e9ances',
        'pricing-complete':'Forfait Complet','pricing-complete-details':'10 heures \u2022 \u00c9conomisez 100$',
        ...
        'pricing-group':'Atelier de Groupe','pricing-group-details':'par personne',
        'pricing-group-duration':'90 minutes','pricing-group-size':'2 \u00e0 4 personnes (max 6)',
        'pricing-group-note':'Apprenez ensemble et \u00e9conomisez',
        'badge-best':'Meilleure Offre','badge-popular':'Le Plus Demand\u00e9',
        ...
        'exp-teaching':"Ann\u00e9es d'Enseignement",'exp-passion':'D\u00e9vou\u00e9 \u00e0 nos A\u00een\u00e9s',
        'exp-local':'R\u00e9sident de la Communaut\u00e9','exp-ai':"Sp\u00e9cialiste en IA",
        'contact-title':'Contact',
        ...
        'form-name':'Votre Nom','form-email':'Adresse Courriel','form-phone':'Num\u00e9ro de T\u00e9l\u00e9phone',
        'form-interest':"Je suis int\u00e9ress\u00e9(e) par",
        'form-referral':'Comment avez-vous entendu parler de moi ?','form-optional':'Optionnel',
        'form-referral-choose':'Choisissez une option...','form-referral-google':'Recherche Google',
        'form-referral-ai':'ChatGPT / Recherche IA','form-referral-friend':'Ami(e) ou famille',
        'form-referral-neighbour':'Voisin(e)','form-referral-csl':'Babillard / Bulletin communautaire de CSL',
        'form-referral-facebook':'Facebook','form-referral-linkedin':'LinkedIn',
        ...
        'form-option-choose':'Choisissez une option...','form-option-online':'Cours Individuel (En ligne)',
        'form-option-home':'Cours Individuel (\u00c0 domicile)','form-option-group':'Atelier de Groupe',
        ...
        'entity-aside':'<strong>AI with Robert</strong> — Tutoriel IA &amp; formation technologique pour aînés à Côte Saint-Luc, QC. Robert Simon enseigne ChatGPT, sécurité Internet, sécurité des courriels, smartphones &amp; appels vidéo. À domicile 65$/h &middot; En ligne 60$/h &middot; Ateliers IA 35$/pers. &middot; Appel découverte gratuit 30 min. &#128222; <a href="tel:514-250-8491">514-250-8491</a> &nbsp;&middot;&nbsp; <a href="mailto:info@aiwithrobert.com">info@aiwithrobert.com</a>'
    }
};
